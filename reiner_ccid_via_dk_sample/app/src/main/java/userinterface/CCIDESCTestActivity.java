 ...
 */
public class CCIDESCTestActivity extends Activity implements
	...
	Connected,/** The PinRequest. */
	PinRequest,/** The SetParameter. */
	SetParameter
    };
	...
	public void didRecieveCCID_DataBlock(CCID_AnswerBlock ccid_AnswerBlock) {
		...
		{
		    currentCCIDState = CCIDState.PinRequest;
			String masterFile = answer.getCommandoData();
			showCardAnswer(masterFile, "Master File");
			_bluetoothService.sendESCBlock("02 00 00 01 02 00 00 00 00 00 1E 86 08 00 08 01 02 01 00 00 00 00 00 00 00 20 00 81 08 00 00 00 00 FF FF FF FF",SlotInUse);
			return;
		}

		if (currentCCIDState == CCIDState.PinRequest)
		{
